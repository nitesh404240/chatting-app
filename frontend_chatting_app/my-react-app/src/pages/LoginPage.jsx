...
const { login, isLoggingIn, loginEmailError, loginPasswordError } = useAuthStore();
      ...
      <div className='flex flex-col  w-auto justify-center items-center   sm:p-12'>
        <div className='w-full max-w-md border p-5 space-y-8'>
          ...
          <form onSubmit={handelSubmit} className='space-y-6'>
              ...
              <button type='submit' className="btn btn-active btn-primary w-full" disabled={isLoggingIn}>
