...
const ProfilePage = () => {
  ...
  const [selectedImage, setSelectedImage] = useState(authUser?.data?.profilepic || "");
                ...
                <div className='flex flex-col items-center'>           
                  ...
                  <div className='w-auto'>
                   <label className='label'>
                       <><User className='size-4'/><h1 className='text-1xl'>
                              Fullname
                        </h1></>
                   </label>
                   <h1 className='w-full text-1xl border rounded-xl py-1 px-3'
                   >{authUser.data.fullname}</h1>
                   <label className='label mt-2'>
                    ...
                    <h1 className='w-full text-1xl border rounded-xl  py-1 px-3'
                   >{authUser.data.username}</h1>
                   <label className='label mt-2'>
                        <><Mail className='size-4'/><h1 className='text-1xl'>
                              Email
                        </h1></>
                       
                   </label>
                   <h1 className='w-full text-1xl border rounded-xl  py-1 px-3'
                   >{authUser.data.email}</h1>
